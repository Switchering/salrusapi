        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order_Id = table.Column<string>(type: "text", nullable: false),
                    Bar_User = table.Column<string>(type: "text", nullable: true),
                    Printer_Name = table.Column<string>(type: "text", nullable: true),
                    Template_Name = table.Column<string>(type: "text", nullable: true),
                    Print_Time = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Naim = table.Column<string>(type: "text", nullable: true),
                    Art = table.Column<string>(type: "text", nullable: false),
                    Art_Color = table.Column<string>(type: "text", nullable: false),
                    Sticker1 = table.Column<string>(type: "text", nullable: false),
                    Sticker2 = table.Column<string>(type: "text", nullable: false),
                    Request = table.Column<string>(type: "text", nullable: false),
                    SHK1 = table.Column<string>(type: "text", nullable: true),
                    SHK2 = table.Column<string>(type: "text", nullable: true),
                    SHK3 = table.Column<string>(type: "text", nullable: true),
                    SHK1C = table.Column<string>(type: "text", nullable: true),
